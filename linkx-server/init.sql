...
CREATE TABLE IF NOT EXISTS `im_message` (
  ...
  `sender_nickname` varchar(100) DEFAULT NULL COMMENT '发送者昵称(冗余)',
  `sender_avatar` varchar(500) DEFAULT NULL COMMENT '发送者头像(冗余)',
  `delivery_status` varchar(20) DEFAULT NULL COMMENT '投递状态(sent/delivered)',
