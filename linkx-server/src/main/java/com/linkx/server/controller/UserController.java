...
public class UserController {
    ...
    public Result<UserPreferenceVO> updatePreference(
        ...
        UserPreference patch = UserPreference.builder()
                ...
                .privacySendReadReceipt(dto.getPrivacySendReadReceipt())
                .language(emptyToNull(dto.getLanguage()))
                .translateTargetLang(emptyToNull(dto.getTranslateTargetLang()))
    ...
    private UserPreferenceVO toPreferenceVO(UserPreference p) {
        ...
        return UserPreferenceVO.builder()
                ...
                .privacySendReadReceipt(p.getPrivacySendReadReceipt() != null ? p.getPrivacySendReadReceipt() : true)
                .language(p.getLanguage())
                .translateTargetLang(p.getTranslateTargetLang() != null ? p.getTranslateTargetLang() : "auto")
