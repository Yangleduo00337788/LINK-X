...
class AdminEndpointPathCatalogIT extends BaseIntegrationTest {
    ...
    private static final String[] GET_PATHS = {
            ...
            "/admin/system-monitor/tables",
            "/admin/system-monitor/cache",
            "/admin/system-monitor/service",
            "/admin/system-monitor/api-stats",
            "/admin/system-monitor/tasks",
            "/admin/system-monitor/sql",
            "/admin/recommends",
            "/admin/recommends/{id}",
