/**
 * 前端 Mock 演示数据
 * 提供初始会话、消息、联系人、收藏与应用列表，以及联系人转会话的工具函数
 */
...
/** 按 sessionId 索引的初始消息记录（仅部分会话有预置消息） */
export const initialMessages: Record<string, ChatMessage[]> = {
  // 吱唔猪单聊：涵盖文件、链接、红包、文本等多种消息类型
  'f-zwz': [
    {
      id: 'zwz-f1',
      sessionId: 'f-zwz',
...
export const apps: AppItem[] = [
  {
    ...
    appKind: 'netease' // 用于解析页面 title 更新播放状态
  },
  {
    id: 'douyin',
    name: '抖音',
...
/**
 * 将通讯录联系人转换为可插入会话列表的 ChatSession
 * @param c 联系人项
 * @returns 新会话对象（尚未写入 Store）
 */
