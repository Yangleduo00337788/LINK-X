...
const MENU_NAME_KEYS: Record<string, string> = {
  ...
  'risk-policy': 'route.riskPolicies',
  'risk-rules': 'route.riskRules',
  'rate-limit': 'route.rateLimits',
  feedback: 'route.feedback',
  'feedback-center': 'route.feedbackCenter',
  'feedback-dispatch-rules': 'route.feedbackDispatchRules',
  'duty-schedules': 'route.dutySchedules',
  review: 'route.review',
  'review-task': 'route.reviews',
  'report-task': 'route.reports',
  'announcement-review': 'route.announcementReviews',
  'approval-flows': 'route.approvalFlows',
  'approval-inbox': 'route.approvalInbox',
  'sensitive-word': 'route.sensitiveWords',
  'security-center': 'route.securityCenter',
  'notice-center': 'route.noticeCenter',
  'ops-center': 'route.opsCenter',
  notices: 'route.notices',
  'notice-inbox': 'route.noticeInbox',
  'homepage-orchestration': 'route.homepageOrchestration',
  banners: 'route.banners',
  recommends: 'route.recommends',
  activities: 'route.activities',
  'scheduled-tasks': 'route.scheduledTasks',
  'system-monitor': 'route.systemMonitor',
  'monitor-cache': 'route.monitorCache',
  'monitor-service': 'route.monitorService',
  'monitor-api': 'route.monitorApi',
  ...
  versions: 'route.versions',
    ...
    'bi-analytics': 'route.biAnalytics',
    'big-screen': 'route.bigScreen',
}
...
const MENU_PATH_KEYS: Record<string, string> = {
  ...
  '/admin/duty-schedules': 'route.dutySchedules',
  '/admin/review': 'route.review',
  '/admin/reviews': 'route.reviews',
  '/admin/reports': 'route.reports',
  '/admin/announcement-reviews': 'route.announcementReviews',
  '/admin/approval-flows': 'route.approvalFlows',
  '/admin/approval-inbox': 'route.approvalInbox',
  '/admin/sensitive-words': 'route.sensitiveWords',
  '/admin/security': 'route.securityCenter',
  '/admin/notice-hub': 'route.noticeCenter',
  '/admin/ops': 'route.opsCenter',
  '/admin/notices': 'route.notices',
  '/admin/notice-inbox': 'route.noticeInbox',
  '/admin/homepage-orchestration': 'route.homepageOrchestration',
  '/admin/banners': 'route.banners',
  '/admin/recommends': 'route.recommends',
  '/admin/activities': 'route.activities',
  '/admin/scheduled-tasks': 'route.scheduledTasks',
  '/admin/system-monitor': 'route.systemMonitor',
  '/admin/system-monitor/cache': 'route.monitorCache',
  '/admin/system-monitor/service': 'route.monitorService',
  '/admin/system-monitor/api-stats': 'route.monitorApi',
  ...
  '/admin/bi-analytics': 'route.biAnalytics',
  '/admin/big-screen': 'route.bigScreen',
}
...
const PERM_KEYS: Record<string, { name: string; desc?: string }> = {
  ...
  'admin:dept:list': { name: 'perm.adminDeptList', desc: 'perm.adminDeptListDesc' },
  'admin:dept:create': { name: 'perm.adminDeptCreate', desc: 'perm.adminDeptCreateDesc' },
  'admin:dept:edit': { name: 'perm.adminDeptEdit', desc: 'perm.adminDeptEditDesc' },
  'admin:dept:delete': { name: 'perm.adminDeptDelete', desc: 'perm.adminDeptDeleteDesc' },
  ...
  'admin:bi:view': { name: 'perm.adminBiView', desc: 'perm.adminBiViewDesc' },
  'admin:big-screen:view': { name: 'perm.adminBigScreenView', desc: 'perm.adminBigScreenViewDesc' },
  'admin:approval-flow:list': { name: 'perm.adminApprovalFlowList', desc: 'perm.adminApprovalFlowListDesc' },
  'admin:approval-flow:create': { name: 'perm.adminApprovalFlowCreate', desc: 'perm.adminApprovalFlowCreateDesc' },
  'admin:approval-flow:edit': { name: 'perm.adminApprovalFlowEdit', desc: 'perm.adminApprovalFlowEditDesc' },
  'admin:approval-flow:delete': { name: 'perm.adminApprovalFlowDelete', desc: 'perm.adminApprovalFlowDeleteDesc' },
  'admin:approval:inbox': { name: 'perm.adminApprovalInbox', desc: 'perm.adminApprovalInboxDesc' },
  'admin:approval:action': { name: 'perm.adminApprovalAction', desc: 'perm.adminApprovalActionDesc' },
  'admin:approval:start': { name: 'perm.adminApprovalStart', desc: 'perm.adminApprovalStartDesc' },
}
