...
export const ROLE_SMOKE_CASES: RoleSmokeCase[] = [
  {
    ...
    allowPerms: ['admin:dashboard:view', 'admin:feedback:reply', 'admin:notice:create'],
    denyPerms: ['admin:setting:edit', 'admin:user:freeze', 'admin:risk-event:handle', 'admin:menu:create'],
  ...
  },
  {
    ...
    denyPerms: ['admin:notice:create', 'admin:setting:edit', 'admin:menu:edit'],
  ...
  },
  {
    ...
    allowPerms: ['admin:risk-event:handle', 'admin:device:kick', 'admin:blacklist:list'],
    denyPerms: ['admin:feedback:reply', 'admin:notice:create', 'admin:menu:delete'],
