...
export const ROLE_SMOKE_CASES: RoleSmokeCase[] = [
  ...
  },
  {
    ...
    mustNotMenus: ['settings-center', 'settings', 'versions', 'risk-event', 'devices', 'rate-limit', 'review-task', 'report-task', 'announcement-review'],
    allowPerms: [
      'admin:dashboard:view',
  ...
  },
  {
    ...
    mustNotMenus: ['notices', 'statistics', 'settings-center', 'settings', 'versions', 'rate-limit', 'feedback', 'feedback-center'],
    allowPerms: [
      'admin:review:approve',
  ...
  },
  {
    ...
    mustNotMenus: ['settings-center', 'settings', 'versions', 'blacklist', 'notices', 'rate-limit', 'feedback', 'feedback-center', 'review-task', 'report-task'],
    allowPerms: [
      'admin:dashboard:view',
